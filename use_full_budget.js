 ...
 * Source: https://searchengineland.com/how-to-stop-underspending-your-free-ad-grant-budget-with-a-script-314775
 * Author: Daniel Gilbert
 * Goal:   Ensure daily budget is fully spent (Spending budget is win win for client and optimiser)
 * Setup:
 * set 
 *    - tolerance parameter - disabble script if within this spend range
 *    - hourlyTargets - to control by cumulative hourly targets. (TODO: learn these from past data.)
